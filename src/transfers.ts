...
app.get('/api/transfers', authenticateUser, async (req, res) => {
  try {
...
app.put('/api/transfers/:id', authenticateUser, async (req, res) => {
  try {
    const { id } = req.params;
...
app.delete('/api/transfers/:id', authenticateUser, async (req, res) => {
  try {
    const { id } = req.params;
...
app.get('/api/transfers/stats', authenticateUser, async (req, res) => {
  try {
